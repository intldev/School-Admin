...
import { ADD_STUDENTS, ADD_STUDENT, DELETE_STUDENT, UPDATE_STUDENT } from '../types';
...
export default function reducer(state: any = initialState.students, { payload, type }: any) {
  switch(type) {
    case ADD_STUDENTS:
